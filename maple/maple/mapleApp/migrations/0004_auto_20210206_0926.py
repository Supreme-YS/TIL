    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('ord', '주문'), ('prep', '준비중'), ('done', '완료')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Staff',
            fields=[
                ...
                ('jobtitle', models.CharField(choices=[('J40', '사원'), ('J10', 'CEO'), ('J50', '아르바이트'), ('J20', '메니저'), ('J30', '메니저')], max_length=20)),
        ...
        migrations.AlterField(
            model_name='user',
            name='user_id',
            field=models.CharField(max_length=50, primary_key=True, serialize=False, verbose_name='사용자'),
        ),
        migrations.CreateModel(
            name='Info',
            fields=[
